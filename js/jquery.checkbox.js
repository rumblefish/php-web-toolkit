...
jQuery.fn.extend({
    ...
    dgEffect: function()
    {
        if($(this).data("checked") == true)
            $(this).css({
                backgroundPosition:"center -"+(elmHeight*3)+"px"
                });
        else
            $(this).css({
    ...
    {
        var elm	=	$(this).children().get(0);
        //CRAIG HANDLE RADIO CLICK ON SELECTED RADIO
        if($(elm).attr('type') == 'radio' && $(this).data("checked") == true) {
            $(this).data('checked',true).css({
